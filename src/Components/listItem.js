  ...
  render () {
    ...
    return (
      <tr className="caseList__item">
        <td className="width-24">{record.id}</td>
        <td className="width-full"><span className={record.isDisable ? 'disable' : ''}><a href='#' id={record.id} onClick={this.props.showDetails}>{ record.name }</a></span></td>
